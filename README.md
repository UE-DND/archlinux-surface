...
> This repository is forked from the upstream [linux-surface/linux-surface](https://github.com/linux-surface/linux-surface) project, and has been modified to support Arch Linux only. The content below is the original README from upstream.
